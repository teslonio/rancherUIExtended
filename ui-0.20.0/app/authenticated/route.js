    ...
    */
    ...
    machineChanged: function(change) {
      console.log('Machine changed:',change);
       /* if (change.data.resource.get('transitioningMessage')==='Installing Rancher agent') {
          var requestedHostId = change.resourceId;
          var accountId = change.data.resource.accountId;
